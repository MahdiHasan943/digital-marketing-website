    ...
    <div id="faq" className="px-8 lg:px-[60px] bg py-[100px]">
      ...
      <div className="grid pt-[90px] grid-cols-1 md:grid-cols-2 gap-10">
        <div className="py-20">
          ...
          <p className="text-[#136cf2] text-center">
            Lorem Ipsum is simply dummy text of the printing.
          </p>
        </div>
        <div className="py-20">
          <h3 className="question text-center py-10">
        ...
        <div className="py-20">
          <h3 className="question py-10 text-center"> Why is SEO Important?</h3>
          <p className="text-[#136cf2] text-center">
            Lorem Ipsum is simply dummy text of the printing.
          </p>
        </div>
        <div className="py-20">
          <h3 className="question py-10 text-center"> What is marketing?</h3>
          <p className="text-[#136cf2] text-center">
            Lorem Ipsum is simply dummy text of the printing.
          </p>
        </div>

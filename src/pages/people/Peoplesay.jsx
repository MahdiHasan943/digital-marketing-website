  ...
  return (
    <div id='people' className='overflow-hidden pb-10 xl:pr-[60px]'>
      ...
      <div className="lg:flex">
        ...
        <div className="lg:w-[80%] ">
          ...
          <div className=" relative">
            ...
            <h2 className='peopleSay leading-[40px]  lg:leading-[84px] text-[44px] lg:text-[88px]'>What <span className='text-[#136CF2]'>people say</span> <br />
              
              about us</h2>
            <p className='text-[#595959] '>As the market leader in Experience Analytics we thrive solving complex digital experience challenges.</p>
           </div>
          </div>
      ...
      {/* 2 */}
          ...
          <div className="bg-[#F9F9F9] absolute hidden 2xl:block right-20 bottom-[10px] py-20 px-10 shadow-md rounded-lg">

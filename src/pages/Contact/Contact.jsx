    ...
    <div id="contact" className="cursor-[pointer]">
      ...
      <div className="px-4 lg:flex pt-20 pb-10 w-full lg:w-[80%] mx-auto justify-center gap-6 ">
        <div className="gm:flex  gap-8  shadow-lg w-full mx-auto py-20 px-10">
          <div className="">
            <img className="w-full h-full" src="Matthias.jpg" alt="" />
          </div>
          <div className="px-8 pt-8">
            ...
            <p className="text-[#191919] pb-2 font-semibold">Matthias Okala</p>
      ...
      {/* 2 section */}
      <h2 className="Make leading-[40px] px-4 lg:leading-[84px] text-[44px] lg:text-[88px] pt-20 pb-4 text-center">
      ...
      <div className="px-4 lg:flex   gap-20 lg:px-[60px] py-20">
        ...
        <div className="lg:w-[30%]">
          ...
          <div className="">
            <p className='pt-4 flex text-white items-center gap-4'> <BsTelephone className="text-white"></BsTelephone> +44 7961 267 350</p>
          ...
          <p className='flex text-white items-center gap-4'><CiLocationOn className="text-white"></CiLocationOn>   Address  <br />  London , EC1V 2NX, United Kingdom</p>
        ...
        <div className="py-10 lg:py-0 lg:w-[70%]">
          ...
          <div className="grid grid-cols-2 gap-20">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-6">
              ...
              <input name={`select`} value=" Political  Marketing" onChange={radioSelect}  type="checkbox"  className="radio py-4 px-4 bg-[#A4A4A4] border-[#CFF37D] checked:bg-[#000] checked:border-black" />
              ...
              {/* 2 */}
              <div className="flex items-center gap-8">
              <input name={`select`} type="checkbox" value={' Web  Development '} onChange={radioSelect}  className="radio py-4 px-4 bg-[#A4A4A4] border-[#CFF37D] checked:bg-[#000] checked:border-black" />
              ...
              {/* 3 */}
              <div className="flex items-center gap-8">
              <input onChange={radioSelect}  value=" Social Media Marketing " name={`select`} type="checkbox"  className="radio py-4 px-4 bg-[#A4A4A4] border-[#CFF37D] checked:bg-[#000] checked:border-black" />
              ...
              {/* 4 */}
              <div className="flex items-center gap-8">
              <input onChange={radioSelect} value="PaidAdvertising" name={`select`} type="checkbox"  className="radio py-4 px-4 bg-[#A4A4A4] border-[#CFF37D] checked:bg-[#000] checked:border-black "/>
              ...
              {/* 5 */}
              <div className="flex items-center gap-8">
              <input onChange={radioSelect}  value=" Web Reputation  "  name={`select`}type="checkbox"  className="radio py-4 px-4 bg-[#A4A4A4] border-[#CFF37D] checked:bg-[#000] checked:border-black" />
              ...
              {/* 6 */}
              <div className="flex items-center gap-8">
              <input value="UI/UX Design  " onChange={radioSelect}   name={`select`} type="checkbox"  className="py-4 px-4 radio bg-[#A4A4A4] border-[#CFF37D] checked:bg-[#000] checked:border-black" />

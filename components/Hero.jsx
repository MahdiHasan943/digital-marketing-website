...
import { textVariant2 } from "@/motion/motion";
const Hero = () => {
  return (
    <section id="hero" className="lg:px-12 px-6 pt-20 pb-[200px]">
      <div className="xl:flex gap-6">
        {/* 1 */}
        <motion.div variants={textVariant2} initial="hidden" whileInView="show"  className="xl:ml-[70px] w-full xl:w-[40%]">
          <motion.h2 variants={textVariant2} initial="hidden" whileInView="show" className="DigitalH2 py-4">Digital marketing agency</motion.h2>
          <motion.h1 variants={textVariant2} initial="hidden" whileInView="show"   className="workH1 text-[44px] leading-[60px] xl:text-[89px] xl:leading-[100px] py-16">
          ...
          <div className=" py-20  text-start">
            <a href="#contact">
            <button className="ml-2 btGlow  sm:ml-0 bg-[#63cb99]  rounded-lg text-white py-8 px-10">
              Get Started
            </button>
           </a>
            <a href="https://wa.me/+447961267350">

            <button className="ml-2 btGlow mt-2 sm:mt-0 sm:mx-8 text-white  rounded-lg bg-[#136CF2] py-8 px-14">
              Let's Talk
              </button>
              </a>
          </div>
            ...
            <div className="grid  grid-cols-1 sm:grid-cols-2">
              <div className="">
                ...
                <div className="flex flex-col items-center gap-6 ">
                  ...
                  <div className="">
                    <p className="text-[#F1F1F1] text-[17px]">Brian Dean</p>

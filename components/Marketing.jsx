...
const Marketing = () => {
  return (
    <div id="marketing" className="px-8 pt-[50px] pb-[70px] lg:px-[60px]">
      <h1 className="Choose pt-20 text-center workH1 text-[44px] leading-[60px] xl:text-[89px] xl:leading-[100px]">
      ...
      <div className="pt-[40px] h-[850px] 1lg:h-[700px] xl:h-[600px] 1xl:h-[550px] 3xl:h-[450px] sliding-cards">
      ...
      {/* others cards */}
      <div className="  h-[850px]  1lg:h-[700px]  xl:h-[600px]  1xl:h-[550px] 3xl:h-[450px]  sliding-cards">
        <div className=" card h-[80%] mt-10 lg:mt-0  mx-auto py-20 px-10">
      ...
      <div className="sm:pt-[100px] block lg:hidden ">
